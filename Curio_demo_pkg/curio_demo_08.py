"""
curio_demo_8.py - Curio tutorial.

(from https://curio.readthedocs.io/en/latest/tutorial.html)

The kids complain until they are allowed to start.
"""
...
async def kid():
    ...
    8.  The kids complain until they can start playing.
...
# Add ability to do something while waiting for an event.
