"""
curio_demo_9.py - Curio tutorial.

(from https://curio.readthedocs.io/en/latest/tutorial.html)

Allow the kids to play until an external event occurs.
"""
...
async def parent():
    ...
    9. Capture an external signal before telling the kids to stop.
...
# Add ability to wait for an external event (i.e. a Control-C).
