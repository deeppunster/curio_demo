"""
curio_demo_13.py - Curio tutorial.

(from https://curio.readthedocs.io/en/latest/tutorial.html)

Kid uses Fibonacci numbers for building the Minecraft game, buy now runs it
in a separate thread with a hard sleep.
"""
...
async def kid():
    ...
    The kid runs the Fibonacci number generator in a separate process.

    13. The kid does a hard wait (time.sleep) after each fibonacci computation.
